...
public class trf_dificil_audio_final extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trf_dificil_audio_final);
        ...
        btnfinalizatarefa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(trf_dificil_audio_final.this, acerto.class));
            }
        });
    }
}